return {
    ...
    dependencies = {'hrsh7th/cmp-path', 'hrsh7th/cmp-buffer', 'saadparwaiz1/cmp_luasnip', 'hrsh7th/cmp-nvim-lsp',
                    'ray-x/cmp-treesitter', 'onsails/lspkind.nvim', 'L3MON4D3/LuaSnip', 'windwp/nvim-autopairs',
